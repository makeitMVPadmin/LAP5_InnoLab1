            ...
            <section className="mb-[1.3rem]">
                ...
                <div className="py-[0.5rem] px-[1.6rem]">
                    ...
                    <div className="mb-[1rem] flex flex-col">
                        ...
                        {(errors.startDate || errors.startTime) && <p className="text-MVP-red text-[1rem] mt-[0.3rem]">Start date and time are required</p>}
                        <label
                            className={`${sectionHeader} !text-[1.3rem] !mb-[0.1rem] !font-bold`}
                        >
                            End
                        ...
                        {(errors.endDate || errors.endTime) && <p className="text-MVP-red text-[1rem] mt-[0.3rem]">End date and time are required</p>}
                    <div className="mb-[1rem] flex flex-col">
                        <label className={`${sectionHeader}`}>
