        ...
        <div className="py-[0.5rem] px-[2rem]">
          <div className="mb-[1rem] flex flex-col">
            ...
            <input
              ...
              maxLength={80}
              className={`${styledBorder} text-[1.2rem] flex items-center ${
                errors.title && "border-MVP-red"
              }`}
            />
            <div className="flex">
              {errors.title && (
          ...
          <div className="mb-[1rem] flex flex-col">
            ...
            <textarea
              ...
              className={`${styledBorder} text-[1.2rem] flex items-center min-h-[12rem] ${
                errors.basicProjectSummary && "border-MVP-red"
              }`}
              maxLength={500}
            />
            <div className="flex">
          ...
          <div className="mb-[1rem] flex flex-col">
            <label htmlFor="skillLevel" className={`${sectionHeader}`}>
              Skill Level<span className="mb-2/3 text-[2rem]">*</span>
            </label>
            <Controller
              name="skillLevel"
              control={control}
          ...
          <div className="mb-[1rem] flex flex-col w-full">
            ...
            >
              ...
              <select
                ...
                className={`focus:outline-none w-full text-[1.2rem] ${
                  selectedDisciplines.length === 3 && "appearance-none"
                }`}
          ...
          <div className="mb-[1rem] flex flex-col">
            ...
            >
              ...
              <select
                ...
                className={`focus:outline-none w-full text-[1.2rem] ${
                  selectedThemes.length === 3 && "appearance-none"
                }`}
          ...
          <div className="mb-[1rem] flex flex-col">
            <label htmlFor="eventDuration" className={`${sectionHeader}`}>
              Event Duration<span className="mb-2/3 text-[2rem]">*</span>
            </label>
            ...
            <div>
              ...
              >
                Start<span className="mb-2/3 text-[2rem]">*</span>
              </span>
              <div
                className={`w-fit h-[3rem] !px-[1rem] !py-0 flex items-center justify-center gap-[1rem] ${styledBorder} hover:border-MVP-dark-blue ${
            ...
            <div>
              <label
                className={`${sectionHeader} !text-[1.3rem] !mb-[0.1rem] !font-bold`}
              >
                End<span className="mb-2/3 text-[2rem]">*</span>
              </label>
              <div
                className={`${styledBorder} w-fit h-[3rem] !px-[1rem] !py-0 flex items-center justify-center gap-[1rem] ${
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <input
                      ...
                      min={watch("startDate")} // This will dynamically update the min value for the end date
                    />
                  )}
                />
                <div className="border-l-[0.18rem] border-MVP-black h-[70%]" />
            ...
            <div className="mb-[1rem] flex flex-col">
              ...
              <div
                className={`${styledBorder} ${
                  errors.timezone && "border-MVP-red"
                }`}
              >
                <select
                  {...register("timezone", {
            ...
            <div className="mb-[1rem] flex flex-col">
              <label className={`${sectionHeader}`}>
                Meeting Link<span className="mb-2/3 text-[2rem]">*</span>
              </label>
              <input
                type="url"
                ...
                className={`${styledBorder} text-[1.2rem] flex items-center ${
                  errors.meetingLink && "border-MVP-red"
                }`}
                maxLength={80}
              />
              <div className="flex">
                ...
                <p className="ml-auto font-bold">
                  {watch("basicProjectSummary")?.length || 0}/80 characters
                </p>
              </div>
            </div>
