        ...
        <article className="flex flex-col w-full md:w-80 h-[34.5625rem] mb-4">
            ...
            <section className="flex flex-col justify-between pt-4 gap-4 flex-1 font-poppins">
                ...
                <Link to={`/join-event/${id}`}>
                    <button
                        type="button"
                        className="flex items-center justify-center w-[12.625rem] h-[3.9375rem] bg-MVP-light-blue border-[3px] border-t-[3px] border-r-[5px] border-b-[5px] border-l-[3px] border-MVP-black rounded-[0.625rem] text-[1.6875rem] font-gilroy font-extrabold cursor-pointer"
